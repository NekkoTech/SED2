    ...
    <div class="container">
        ...
        <div class="row">
            <div class="text-center">
                ...
                <asp:GridView ID="GvMaterias" CssClass="GridViewStyle w-auto" HeaderStyle-CssClass="HeaderStyle" runat="server" AutoGenerateColumns="False" DataKeyNames="IdMateria" OnRowCommand="GvMaterias_RowCommand" OnSelectedIndexChanged="GvMaterias_SelectedIndexChanged" Width="920px" DataSourceID="SDSPlanEstudio">
                    <Columns>
